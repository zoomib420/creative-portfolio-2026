...
export function ElevatorNav() {
  ...
  return (
    <nav
      ...
      className="content-layer fixed top-1/2 right-2 z-30 -translate-y-1/2 md:right-6"
    >
      <div className="flex flex-col items-center gap-1.5 sm:gap-2 rounded-3xl border border-[var(--color-glow)] bg-[var(--color-ink)] p-1.5 sm:p-2.5 shadow-[0_10px_30px_-12px_rgba(122,90,60,0.45)]">
        <span aria-hidden title="ลิฟต์" className="pt-1 pb-0.5 text-sm sm:text-base">
          🛗
        </span>
