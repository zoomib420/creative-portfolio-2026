...
export interface Profile {
  ...
  /** Small hiring/status line shown near the hero and contact CTA. */
...
export const profile: Profile = {
  ...
  availability: {
    th: 'เปิดรับงาน AI Trainer / Evaluator และงาน Automation — ทำงานทางไกล',
    en: 'Open to AI Trainer / AI Evaluator & Automation roles — Remote-first',
  },
  bio: { 
  ...
  socials: [
    ...
    { label: 'LinkedIn', url: 'https://www.linkedin.com/in/pawasit-chairat-28049b205' },
  ],
  contactCta: {
